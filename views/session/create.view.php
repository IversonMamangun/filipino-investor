...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <img src="assets/navlogo.png" alt="Your Company" class="mx-auto h-10 w-auto" />
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form action="/session" method="POST" class="space-y-6">
      ...
      <div>
        ...
        <a href="../" class="<?= urlIs('/') ?> flex w-full justify-center rounded-md bg-indigo-600 px-3 mt-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Back to Homepage
        </a>
</div>
